...
2. 先判定发言主体：若原话包含“我、我们、我的、我该、我如何、怎么回复、怎么说”等信号，默认替说话者本人写一段可以直接发出去的话，用第一人称“我/我们”；不要改成“你/您/他”的旁观评价。
...
5. 按用户要求选择辞气；没有指定时，根据语境选最自然的一种。
6. 先讲一个能听懂的故事、常识、自然现象或古代旧事，再转到眼前小事。
7. 像课本白话译文那样，把省略的主语、关系和名分补出来：谁对谁、该尽什么本分、乱了什么分寸。
8. 使用“承认—转折—类比—定论或反问”的结构，把小事郑重地说圆。
9. 写完后删去生僻文言、重复说理、空泛赞美和机械套话。
10. 默认只输出改写结果；用户要求分析时再解释写法。
